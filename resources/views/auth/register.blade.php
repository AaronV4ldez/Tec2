                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <select id="level" class="form-control @error('level') is-invalid @enderror" name="level" value="{{ old('level') }}" required autocomplete="Selecciona el tipo de usuario">
                        ...
                        <div class="p-5">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" required autocomplete="name" autofocus placeholder="Apellidos">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="{{ url('/inicio') }}">¿Ya tienes una cuenta? ¡Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('content2')
<!--ORIGINAL, NO TOCAR :[ si la borras te voy a odiar el resto de mi exitencia Ulises del futuro-->
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
